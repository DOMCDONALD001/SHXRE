    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='flex flex-col gap-3 text-center'>
        <h2 className='text-2xl font-bold'>Customize your view</h2>
          <p className='text-light-secondary dark:text-dark-secondary'>
            These settings affect all the SHXRE accounts on this browser.
          </p>
      </div>
      <article
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/shxre-avatar.png' alt='SHXRE' />
          <div>
            <div className='flex gap-1 items-center'>
              <UserName verified name='SHXRE' />
              <p className='text-light-secondary dark:text-dark-secondary ml-2'>
                @shxre
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
                At the heart of SHXRE are short messages called Posts — just
                like this one — which can include photos, videos, links, text,
                hashtags, and mentions like{' '}
                <span className='text-main-accent'>@shxre</span>.
            </p>
          </div>
        </div>
      </article>
