...
function TwitterIcon({ className }: IconProps): JSX.Element {
  // Render the SHXRE logo image instead of the Twitter bird.
  // Place `shxre-logo.png` in the `public/assets` folder (public/assets/shxre-logo.png).
  return (
    // eslint-disable-next-line jsx-a11y/alt-text
    <img
      src='/assets/shxre-logo.png'
      className={cn(className ?? 'h-6 w-6', 'block object-contain')}
      alt='SHXRE'
    />
  );
}
...
function EyeOn({ className }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
...
function EyeOff({ className }: IconProps): JSX.Element {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      fill='none'
